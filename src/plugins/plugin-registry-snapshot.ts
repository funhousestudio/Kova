    ...
    if (persistedReadsEnabled && persistedIndex) {
      if (
        ...
        diagnostics.push({
          ...
          message:
            "Persisted plugin registry policy does not match current config; using derived plugin index. Run `kova plugins registry --refresh` to update the persisted registry.",
        });
        ...
        diagnostics.push({
          ...
          message:
            "Persisted plugin registry points at missing plugin files; using derived plugin index. Run `kova plugins registry --refresh` to update the persisted registry.",
        });
        ...
        diagnostics.push({
          ...
          code: "persisted-registry-stale-source",
          message:
            "Persisted plugin registry contains diagnostics referencing missing paths; using derived plugin index. Run `kova plugins registry --refresh` to update the persisted registry.",
        });
        ...
        diagnostics.push({
          ...
          code: "persisted-registry-stale-source",
          message:
            "Persisted plugin registry is missing config-path startup metadata; using derived plugin index. Run `kova plugins registry --refresh` to update the persisted registry.",
        });
        ...
        diagnostics.push({
          ...
          code: "persisted-registry-stale-source",
          message:
            "Persisted plugin registry metadata no longer matches plugin manifest or package files; using derived plugin index. Run `kova plugins registry --refresh` to update the persisted registry.",
        });
      } else if (
        ...
        diagnostics.push({
          ...
          code: "persisted-registry-stale-source",
          message:
            "Persisted plugin registry is missing recoverable managed npm plugins; using derived plugin index. Run `kova plugins registry --refresh` to update the persisted registry.",
        });
      } else {
