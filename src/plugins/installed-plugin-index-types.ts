...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by OpenClaw from plugin manifests, install records, and config policy. Use `kova plugins registry --refresh`, `kova plugins install/update/uninstall`, or `kova plugins enable/disable` instead.";
