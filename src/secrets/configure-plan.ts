/** Builds the interactive `kova secrets configure` target list and apply plan. */
...
/** Credential target shown by `kova secrets configure` before a SecretRef is selected. */
...
export function buildSecretsConfigurePlan(params: {
  ...
  return {
    ...
    generatedBy: "kova secrets configure",
