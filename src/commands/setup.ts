...
export async function setupCommand(
  ...
  runtime.log(`Next guided path: ${formatCliCommand("kova onboard")}.`);
  runtime.log(
    `Next targeted changes: ${formatCliCommand("kova configure")} for models, channels, Gateway, plugins, skills, and health checks.`,
  );
  runtime.log(`Add a chat channel later: ${formatCliCommand("kova channels add")}.`);
}
