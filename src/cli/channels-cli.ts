...
export async function registerChannelsCli(
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["kova channels list", "List configured channels."],
          ["kova channels list --all", "Show configured, bundled, and installable channels."],
          ["kova channels add", "Open guided channel setup."],
  ...
  const addCommand = channels
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["kova channels add", "Open guided setup for available chat channels."],
          [
            "kova channels add --channel telegram --token <token>",
            "Add or update Telegram non-interactively.",
          ],
          ["kova channels list --all", "Find channel ids before using --channel."],
        ])}\n`,
    )
    .option("--channel <name>", `Channel (${channelNames})`)
