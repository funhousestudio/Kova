...
/** Register `kova agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ...
  ["kova agent --agent ops --message-file ./task.md", "Read a multiline message file."],
  [
    'kova agent --session-key agent:ops:incident-42 --message "Summarize status"',
