...
/** Parse `kova health` flags for the route-first status family. */
...
/** Parse `kova status` flags without registering the full command tree. */
...
/** Parse `kova gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `kova sessions` filters for JSON/list route execution. */
...
/** Parse `kova agents list` display switches for route-first execution. */
...
/** Parse `kova config get <path>` while preserving root option handling. */
...
/** Parse `kova config unset <path>` and its mutation guard flags. */
...
/** Parse `kova models list` filters for the lightweight model catalog route. */
...
/** Parse `kova models status` probe controls for the route-first status path. */
...
/** Parse `kova channels list` display flags for the route-first list path. */
...
/** Parse `kova channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `kova plugins list` flags for plugin inventory output. */
...
/** Parse both `kova tasks --json` and `kova tasks list --json` aliases. */
...
/** Parse JSON-only `kova tasks audit` filters for the route-first audit path. */
