// Formatting layer for `kova skills` commands; keeps discovery data separate from terminal UI.
...
export function formatSkillInfo(
  ...
  if (!skill) {
    ...
    return appendClawHubHint(
      `Skill "${safeRequestedName}" not found. Run \`${formatCliCommand("kova skills list")}\` to see available skills.`,
      opts.json,
    );
  }
